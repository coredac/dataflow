...
// MAPPING-NEXT:     %18 = "neura.not"(%17) {dfg_id = 24 : i32, mapping_locs = [{id = 11 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 18 : i32, x = 3 : i32, y = 2 : i32}]} : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
// MAPPING-NEXT:     %19 = "neura.data_mov"(%10) {dfg_id = 27 : i32, mapping_locs = [{id = 320 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 19 : i32}]} : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
// MAPPING-NEXT:     %20 = "neura.data_mov"(%18) {dfg_id = 28 : i32, mapping_locs = [{id = 35 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 18 : i32}, {id = 328 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 8 : i32, resource = "register", time_step = 19 : i32}]} : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
// MAPPING-NEXT:     %21 = neura.grant_predicate %19, %20 {dfg_id = 34 : i32, mapping_locs = [{id = 10 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 2 : i32, y = 2 : i32}]} : !neura.data<i1, i1>, !neura.data<i1, i1> -> !neura.data<i1, i1>
...
// MAPPING-NEXT:     %84 = "neura.data_mov"(%72) {dfg_id = 242 : i32, mapping_locs = [{id = 296 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 8 : i32, resource = "register", time_step = 23 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %86 = "neura.data_mov"(%85) {dfg_id = 260 : i32, mapping_locs = [{id = 27 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 24 : i32}, {id = 26 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 25 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %119 = "neura.add"(%117, %118) {dfg_id = 269 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 25 : i32, x = 0 : i32, y = 2 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %120 = "neura.data_mov"(%119) {dfg_id = 277 : i32, mapping_locs = [{id = 8000 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 25 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%120, %121) {dfg_id = 286 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 11 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 26 : i32, x = 0 : i32, y = 2 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %150 = "neura.load"(%149) {dfg_id = 229 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 23 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %153 = "neura.add"(%151, %152) {dfg_id = 268 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 25 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %154 = "neura.data_mov"(%153) {dfg_id = 276 : i32, mapping_locs = [{id = 2000 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 25 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%154, %155) {dfg_id = 285 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 11 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 26 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %170 = "neura.data_mov"(%169) {dfg_id = 216 : i32, mapping_locs = [{id = 1000 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 19 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<!llvm.ptr, i1>
// MAPPING-NEXT:     %171 = "neura.load"(%170) {dfg_id = 228 : i32, mapping_locs = [{id = 1 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 1 : i32, y = 0 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %174 = "neura.mul"(%172, %173) {dfg_id = 248 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 22 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %185 = "neura.data_mov"(%184) {dfg_id = 236 : i32, mapping_locs = [{id = 3000 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 23 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %187 = "neura.add"(%185, %186) {dfg_id = 267 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 24 : i32, x = 3 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %188 = "neura.data_mov"(%187) {dfg_id = 275 : i32, mapping_locs = [{id = 3000 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 24 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%188, %189) {dfg_id = 284 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 25 : i32, x = 3 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %261 = "neura.load"(%260) {dfg_id = 312 : i32, mapping_locs = [{id = 1 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 21 : i32, x = 1 : i32, y = 0 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
...
// ASM-NEXT: {
// ASM-NEXT:   ICMP_ULT, [$0], [#4] -> [EAST, RED], [$17], [NORTH, RED] (t=4, inv_iters=0)
...
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$9] (t=8, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   AND, [$8], [#3] -> [$0], [NORTH, RED] (t=9, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$0] -> [EAST, RED] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   ICMP_EQ, [$0], [#0] -> [EAST, RED], [$8], [$0] (t=10, inv_iters=0)
...
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$9], [$17] -> [$0] (t=13, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_ONCE, [$0] -> [WEST, RED], [NORTH, RED], [EAST, RED] (t=2, inv_iters=0)
...
// ASM-NEXT:   LOAD, [$0] -> [EAST, RED] (t=20, inv_iters=1)
...
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$16], [$17] -> [EAST, RED] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$9] (t=9, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$16] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [NORTH, RED] -> [WEST, RED] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$17] (t=12, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   OR, [$9], [#3] -> [NORTH, RED], [$0], [EAST, RED] (t=13, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
...
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$16] (t=21, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$0] (t=21, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$8] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   MUL, [$0], [$8] -> [EAST, RED] (t=22, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$0] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$16] -> [$16] (t=23, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$24] (t=23, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$1] (t=23, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$8] (t=23, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   PHI, [$0], [$1], [$8] -> [EAST, RED] (t=24, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$8] (t=24, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$16], [$24] -> [$0] (t=25, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
...
// ASM-NEXT:   GEP, [arg5], [$0] -> [$9], [$16] (t=19, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$0] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$8] -> [WEST, RED] (t=20, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [NORTH, RED] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$0] -> [$0] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   MUL, [WEST, RED], [$0] -> [WEST, RED] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$9] -> [$0] (t=23, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$8] (t=23, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$0], [$8] -> [$0] (t=24, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   STORE, [$0], [$16] (t=25, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$0] (t=25, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   RETURN_VOID, [$0] (t=26, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=11)
// ASM: PE(0,1):
// ASM-NEXT: {
// ASM-NEXT:   GEP, [arg3], [$24] -> [NORTH, RED] (t=15, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$0] (t=15, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$25], [$8] -> [EAST, RED] (t=17, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
// ASM-NEXT:   SEXT, [$0] -> [$0] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [arg4], [$0] -> [NORTH, RED] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$17], [$26] -> [$0] (t=23, inv_iters=1)
...
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$25] (t=10, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$16] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$8], [$0] -> [$17], [$8] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$26] (t=12, inv_iters=0)
...
// ASM: PE(1,1):
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [WEST, RED], [$10] -> [$8], [EAST, RED], [NORTH, RED], [$0] (t=15, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [SOUTH, RED], [$26] -> [EAST, RED] (t=17, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$8] (t=3, inv_iters=0)
// ASM-NEXT:   PHI_START, [WEST, RED], [$25] -> [EAST, RED], [$0] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [WEST, RED], [$0] -> [$8], [$24], [WEST, RED], [NORTH, RED], [EAST, RED], [SOUTH, RED], [$0] (t=8, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   ICMP_EQ, [$0], [SOUTH, RED] -> [$0], [$9], [WEST, RED] (t=10, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [$25] (t=25, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=10)
