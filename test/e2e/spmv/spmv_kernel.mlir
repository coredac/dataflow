...
//
// MAPPING: module attributes {dlti.dl_spec = #dlti.dl_spec<i128 = dense<128> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, !llvm.ptr = dense<64> : vector<4xi64>, i1 = dense<8> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, f64 = dense<64> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f128 = dense<128> : vector<2xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, i64 = dense<64> : vector<2xi64>, "dlti.stack_alignment" = 128 : i64, "dlti.endianness" = "little">, llvm.ident = "clang version 20.1.7 (https://github.com/llvm/llvm-project.git 6146a88f60492b520a36f8f8f3231e15f3cc6082)"} {
...
// MAPPING-NEXT:     %59 = "neura.load"(%58) {dfg_id = 124 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 0 : i32, y = 2 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %66 = "neura.data_mov"(%65) {dfg_id = 168 : i32, mapping_locs = [{id = 12 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 18 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<i64, i1>
// MAPPING-NEXT:     %67 = "neura.gep"(%66) <{operandSegmentSizes = array<i32: 0, 1>}> {dfg_id = 182 : i32, lhs_value = "%arg4", mapping_locs = [{id = 8 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 19 : i32, x = 0 : i32, y = 2 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
...
// MAPPING-NEXT:     %70 = "neura.data_mov"(%69) {dfg_id = 224 : i32, mapping_locs = [{id = 24 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 21 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %71 = "neura.data_mov"(%59) {dfg_id = 138 : i32, mapping_locs = [{id = 24 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 20 : i32}, {id = 288 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 21 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %72 = "neura.mul"(%70, %71) {dfg_id = 233 : i32, mapping_locs = [{id = 9 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 22 : i32, x = 1 : i32, y = 2 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %82 = "neura.load"(%81) {dfg_id = 210 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 23 : i32, x = 0 : i32, y = 2 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %83 = "neura.data_mov"(%82) {dfg_id = 223 : i32, mapping_locs = [{id = 8000 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 23 : i32}, {id = 24 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 24 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %85 = "neura.add"(%83, %84) {dfg_id = 251 : i32, mapping_locs = [{id = 9 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 25 : i32, x = 1 : i32, y = 2 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%86, %87) {dfg_id = 270 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 12 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 27 : i32, x = 0 : i32, y = 2 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %113 = "neura.data_mov"(%112) {dfg_id = 193 : i32, mapping_locs = [{id = 30 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 18 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<i64, i1>
// MAPPING-NEXT:     %114 = "neura.gep"(%113) <{operandSegmentSizes = array<i32: 0, 1>}> {dfg_id = 208 : i32, lhs_value = "%arg5", mapping_locs = [{id = 13 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 19 : i32, x = 1 : i32, y = 3 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
...
// MAPPING-NEXT:     %116 = "neura.load"(%115) {dfg_id = 231 : i32, mapping_locs = [{id = 12 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 24 : i32, x = 0 : i32, y = 3 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %117 = "neura.data_mov"(%116) {dfg_id = 240 : i32, mapping_locs = [{id = 12000 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 24 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %119 = "neura.add"(%117, %118) {dfg_id = 269 : i32, mapping_locs = [{id = 12 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 25 : i32, x = 0 : i32, y = 3 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %120 = "neura.data_mov"(%119) {dfg_id = 277 : i32, mapping_locs = [{id = 12000 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 25 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%120, %121) {dfg_id = 286 : i32, mapping_locs = [{id = 12 : i32, index_per_ii = 11 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 26 : i32, x = 0 : i32, y = 3 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %127 = "neura.load"(%126) {dfg_id = 149 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %138 = "neura.data_mov"(%137) {dfg_id = 239 : i32, mapping_locs = [{id = 2000 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 21 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %140 = "neura.mul"(%138, %139) {dfg_id = 249 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 22 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %150 = "neura.load"(%149) {dfg_id = 229 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 23 : i32, x = 3 : i32, y = 0 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %151 = "neura.data_mov"(%150) {dfg_id = 238 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 23 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %153 = "neura.add"(%151, %152) {dfg_id = 268 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 24 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %154 = "neura.data_mov"(%153) {dfg_id = 276 : i32, mapping_locs = [{id = 6 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 24 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%154, %155) {dfg_id = 285 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 25 : i32, x = 3 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %172 = "neura.data_mov"(%171) {dfg_id = 237 : i32, mapping_locs = [{id = 1016 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 16 : i32, resource = "register", time_step = 21 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %173 = "neura.data_mov"(%161) {dfg_id = 160 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 20 : i32}, {id = 5 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 21 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %174 = "neura.mul"(%172, %173) {dfg_id = 248 : i32, mapping_locs = [{id = 1 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 22 : i32, x = 1 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %184 = "neura.load"(%183) {dfg_id = 227 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 22 : i32, x = 3 : i32, y = 0 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %185 = "neura.data_mov"(%184) {dfg_id = 236 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 22 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %186 = "neura.data_mov"(%174) {dfg_id = 257 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 22 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %187 = "neura.add"(%185, %186) {dfg_id = 267 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 23 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %188 = "neura.data_mov"(%187) {dfg_id = 275 : i32, mapping_locs = [{id = 6 : i32, index_per_ii = 8 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 23 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%188, %189) {dfg_id = 284 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 9 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 24 : i32, x = 3 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %201 = neura.grant_predicate %199, %200 {dfg_id = 188 : i32, mapping_locs = [{id = 13 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 21 : i32, x = 1 : i32, y = 3 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
// MAPPING-NEXT:     neura.ctrl_mov %201 -> %53 {dfg_id = 203 : i32, mapping_locs = [{id = 42 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 21 : i32}, {id = 29 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 22 : i32}]} : !neura.data<i64, i1> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %214 = "neura.data_mov"(%46) {dfg_id = 77 : i32, mapping_locs = [{id = 4008 : i32, index_per_ii = 12 : i32, invalid_iterations = 0 : i32, per_tile_register_id = 8 : i32, resource = "register", time_step = 12 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %221 = "neura.data_mov"(%213) {dfg_id = 170 : i32, mapping_locs = [{id = 168 : i32, index_per_ii = 12 : i32, invalid_iterations = 0 : i32, per_tile_register_id = 8 : i32, resource = "register", time_step = 12 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %227 = neura.grant_predicate %225, %226 {dfg_id = 68 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 22 : i32, x = 0 : i32, y = 2 : i32}]} : !neura.data<i1, i1>, !neura.data<i1, i1> -> !neura.data<i1, i1>
...
// MAPPING-NEXT:     %261 = "neura.load"(%260) {dfg_id = 312 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 21 : i32, x = 3 : i32, y = 0 : i32}]} : (!neura.data<!llvm.ptr, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %264 = "neura.mul"(%262, %263) {dfg_id = 315 : i32, mapping_locs = [{id = 15 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 25 : i32, x = 3 : i32, y = 3 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %269 = "neura.data_mov"(%268) {dfg_id = 281 : i32, mapping_locs = [{id = 24 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 18 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %270 = neura.sext %269 {dfg_id = 289 : i32, mapping_locs = [{id = 9 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 19 : i32, x = 1 : i32, y = 2 : i32}]} : !neura.data<i32, i1> -> !neura.data<i64, i1>
// MAPPING-NEXT:     %271 = "neura.data_mov"(%270) {dfg_id = 295 : i32, mapping_locs = [{id = 288 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 19 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<i64, i1>
// MAPPING-NEXT:     %272 = "neura.gep"(%271) <{operandSegmentSizes = array<i32: 0, 1>}> {dfg_id = 301 : i32, lhs_value = "%arg5", mapping_locs = [{id = 9 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 1 : i32, y = 2 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<!llvm.ptr, i1>
...
// MAPPING-NEXT:     %276 = "neura.data_mov"(%264) {dfg_id = 316 : i32, mapping_locs = [{id = 46 : i32, index_per_ii = 10 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 25 : i32}, {id = 43 : i32, index_per_ii = 11 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 26 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %277 = "neura.add"(%275, %276) {dfg_id = 317 : i32, mapping_locs = [{id = 13 : i32, index_per_ii = 12 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 27 : i32, x = 1 : i32, y = 3 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %278 = "neura.data_mov"(%277) {dfg_id = 318 : i32, mapping_locs = [{id = 40 : i32, index_per_ii = 12 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 27 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%278, %279) {dfg_id = 319 : i32, mapping_locs = [{id = 12 : i32, index_per_ii = 13 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 28 : i32, x = 0 : i32, y = 3 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// ASM: PE(0,0):
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [EAST, RED] (t=15, inv_iters=1)
...
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [EAST, RED] -> [$8], [$0] (t=3, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   ICMP_ULT, [$0], [#4] -> [EAST, RED], [$24], [NORTH, RED] (t=4, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   ZEXT, [$8] -> [$8], [$0] (t=5, inv_iters=0)
...
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$16] -> [EAST, RED], [$0] (t=8, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$16] (t=8, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   AND, [$8], [#3] -> [$0], [$8] (t=9, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$0] -> [EAST, RED] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   ICMP_EQ, [$0], [#0] -> [NORTH, RED], [$8], [$0] (t=10, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$8] -> [EAST, RED] (t=10, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   NOT, [$0] -> [NORTH, RED], [$8], [$0] (t=11, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$8] -> [EAST, RED] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [NORTH, RED] (t=12, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$16], [$24] -> [$0] (t=13, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$0] -> [NORTH, RED] (t=13, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [$16] (t=13, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_ONCE, [$0] -> [WEST, RED], [NORTH, RED], [$24] (t=2, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$8] (t=5, inv_iters=0)
// ASM-NEXT:   NOT, [$24] -> [NORTH, RED] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$0] (t=6, inv_iters=0)
// ASM-NEXT:   LOAD, [$0] -> [$16] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   MUL, [$16], [EAST, RED] -> [EAST, RED] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$16] (t=9, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [NORTH, RED] (t=9, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [EAST, RED] (t=24, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [WEST, RED] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [NORTH, RED] -> [WEST, RED] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=12, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [NORTH, RED] (t=27, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   OR, [$16], [#3] -> [NORTH, RED], [$0], [EAST, RED] (t=13, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [$0] -> [EAST, RED] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [NORTH, RED] -> [$8] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [NORTH, RED] -> [$0] (t=21, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [WEST, RED] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   MUL, [$0], [$8] -> [$0] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [EAST, RED], [WEST, RED] -> [EAST, RED] (t=23, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [NORTH, RED] -> [WEST, RED] (t=23, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [EAST, RED], [$0] -> [EAST, RED] (t=24, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   CTRL_MOV, [WEST, RED] -> [WEST, RED] (t=25, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [WEST, RED] (t=13, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
...
// ASM-NEXT: {
// ASM-NEXT:   SEXT, [$0] -> [$0] (t=18, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$8] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [$0] -> [$16], [$24] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$8] -> [WEST, RED] (t=20, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$8] (t=20, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$0] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$0] -> [NORTH, RED] (t=21, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$0] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$16] -> [WEST, RED] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [$8] -> [WEST, RED] (t=23, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   STORE, [WEST, RED], [$24] (t=24, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   STORE, [WEST, RED], [$0] (t=25, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=10)
// ASM: PE(0,1):
// ASM-NEXT: {
// ASM-NEXT:   GEP, [$24] -> [NORTH, RED] (t=15, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$0] (t=15, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$8], [$16] -> [EAST, RED] (t=17, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
// ASM-NEXT:   SEXT, [$0] -> [NORTH, RED] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   NOT, [SOUTH, RED] -> [SOUTH, RED], [$0] (t=5, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [EAST, RED], [$0] -> [$8], [EAST, RED], [$0] (t=6, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   CTRL_MOV, [NORTH, RED] -> [$0] (t=23, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$24] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$16] (t=11, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$8], [$0] -> [EAST, RED], [$8] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [NORTH, RED] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$0] (t=12, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$8], [$16] -> [SOUTH, RED] (t=13, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$8] (t=13, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [EAST, RED], [$0] -> [EAST, RED] (t=14, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [NORTH, RED] (t=14, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$16] (t=14, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=14)
// ASM: PE(1,1):
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [WEST, RED], [$0] -> [$8], [EAST, RED], [NORTH, RED], [$0] (t=15, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [WEST, RED] (t=15, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$0], [#1] -> [EAST, RED] (t=16, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [$8] -> [NORTH, RED] (t=16, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [NORTH, RED] -> [$0] (t=31, inv_iters=2)
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [SOUTH, RED], [$0] -> [EAST, RED] (t=17, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$8] (t=3, inv_iters=0)
// ASM-NEXT:   PHI_START, [WEST, RED], [$24] -> [EAST, RED], [$0] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [SOUTH, RED], [$0], [WEST, RED] (t=5, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [WEST, RED], [$16] -> [EAST, RED] (t=7, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [WEST, RED], [NORTH, RED] -> [$8], [$24], [WEST, RED], [NORTH, RED], [EAST, RED], [SOUTH, RED], [$0] (t=8, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$0], [#4] -> [NORTH, RED], [$8] (t=9, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$8] -> [EAST, RED] (t=9, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$0] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   ICMP_EQ, [$0], [SOUTH, RED] -> [$0], [$16], [WEST, RED] (t=10, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$8], [$16] -> [$8] (t=12, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   PHI, [$0], [$8] -> [WEST, RED] (t=13, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [NORTH, RED] (t=13, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [$16] (t=13, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [SOUTH, RED] -> [$0] (t=28, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [$24] -> [WEST, RED] (t=14, inv_iters=0)
