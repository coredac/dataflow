...
// ASM: } (idx_per_ii=8)
// ASM: {
// ASM:   PHI_START, [UNRESOLVED, ERROR], [$0] -> [$0] (t=9, inv_iters=0)
// ASM:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=9, inv_iters=0)
// ASM: } (idx_per_ii=9)
// ASM: {
// ASM:   PHI_START, [UNRESOLVED, ERROR], [$0] -> [$4], [$0] (t=10, inv_iters=0)
...
// ASM: } (idx_per_ii=6)
// ASM: {
// ASM:   PHI_START, [UNRESOLVED, ERROR], [$0] -> [NORTH, RED], [$0] (t=7, inv_iters=0)
// ASM: } (idx_per_ii=7)
// ASM: {
// ASM:   PHI_START, [UNRESOLVED, ERROR], [$0] -> [NORTH, RED], [$2], [$0] (t=8, inv_iters=0)
// ASM: } (idx_per_ii=8)
// ASM: {
...
// ASM: } (idx_per_ii=7)
// ASM: {
// ASM:   PHI_START, [UNRESOLVED, ERROR], [$0] -> [$2], [NORTH, RED], [$0] (t=8, inv_iters=0)
// ASM: } (idx_per_ii=8)
// ASM: {
// ASM:   PHI_START, [UNRESOLVED, ERROR], [$0] -> [WEST, RED], [EAST, RED], [$0] (t=9, inv_iters=0)
...
// ASM: } (idx_per_ii=0)
// ASM: {
// ASM:   PHI_START, [UNRESOLVED, ERROR], [$1] -> [EAST, RED] (t=12, inv_iters=1)
