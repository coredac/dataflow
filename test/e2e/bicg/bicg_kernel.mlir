...
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_ONCE, [$0] -> [NORTH, RED], [EAST, RED], [$1] (t=2, inv_iters=0)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$4] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM:     PE(1,0):
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [$0], [EAST, RED] -> [NORTH, RED], [$0] (t=10, inv_iters=1)
