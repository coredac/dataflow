...
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [NORTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_ONCE, [$0] -> [EAST, RED], [NORTH, RED], [$0], [$2] (t=2, inv_iters=0)
// ASM-NEXT:     DATA_MOV, [EAST, RED] -> [$3] (t=2, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [EAST, RED], [$0] -> [$0], [$1] (t=3, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     ICMP_SGT, [$0], [#0] -> [$0], [EAST, RED], [NORTH, RED] (t=4, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=4)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$1], [$0] -> [EAST, RED] (t=7, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=7)
// ASM-NEXT:     {
// ASM-NEXT:     NOT, [$2] -> [$0], [NORTH, RED], [EAST, RED] (t=8, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=8)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$3], [$0] -> [$0], [EAST, RED] (t=9, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=9)
// ASM-NEXT:     {
// ASM-NEXT:     ICMP_SGT, [$0], [#0] -> [EAST, RED], [NORTH, RED] (t=10, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=10)
// ASM:     PE(1,0):
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [WEST, RED] -> [$0] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     ZEXT, [$0] -> [EAST, RED] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
...
// ASM-NEXT:     CTRL_MOV, [NORTH, RED] -> [$1] (t=16, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=5)
// ASM-NEXT:     {
// ASM-NEXT:     ZEXT, [WEST, RED] -> [$0] (t=8, inv_iters=0)
// ASM-NEXT:     CTRL_MOV, [NORTH, RED] -> [$2] (t=19, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=8)
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [$0], [NORTH, RED] -> [$0] (t=9, inv_iters=0)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=9, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=9)
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [$0], [NORTH, RED] -> [NORTH, RED] (t=10, inv_iters=0)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [$0] (t=10, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=10)
// ASM:     PE(2,0):
// ASM-NEXT:     {
// ASM-NEXT:     LOAD, [NORTH, RED] -> [NORTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [$0] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [$0] (t=2, inv_iters=0)
// ASM-NEXT:     GRANT_PREDICATE, [NORTH, RED], [$0] -> [NORTH, RED] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     SHL, [$0], [#3] -> [NORTH, RED] (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=4, inv_iters=0)
...
// ASM:     PE(3,0):
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [NORTH, RED], [$0] -> [WEST, RED] (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
...
// ASM:     PE(0,1):
// ASM-NEXT:     {
// ASM-NEXT:     GEP, [$0] -> [EAST, RED], [NORTH, RED], [SOUTH, RED] (t=11, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [EAST, RED] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [$1], [NORTH, RED] -> [NORTH, RED], [$0] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$1] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
...
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [EAST, RED], [$0] -> [$0] (t=4, inv_iters=0)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [EAST, RED] (t=4, inv_iters=0)
// ASM-NEXT:     CTRL_MOV, [NORTH, RED] -> [$2] (t=15, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=4)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [SOUTH, RED] -> [EAST, RED], [$0] (t=5, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=5)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [EAST, RED] -> [$1] (t=7, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=7)
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [$0], [EAST, RED] -> [$0], [NORTH, RED], [EAST, RED] (t=8, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=8)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [EAST, RED] (t=9, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=9)
// ASM:     PE(1,1):
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [NORTH, RED] -> [EAST, RED] (t=11, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$0] (t=11, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     GEP, [$1], [$2] -> [EAST, RED], [NORTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$0] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$3], [$0] -> [$1] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=13, inv_iters=1)
...
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$2], [$0] -> [SOUTH, RED] (t=15, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=4)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [NORTH, RED] (t=5, inv_iters=0)
// ASM-NEXT:     CTRL_MOV, [NORTH, RED] -> [$4] (t=16, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=5)
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [WEST, RED], [NORTH, RED] -> [WEST, RED], [$0] (t=6, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=6)
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [$0], [$1] -> [EAST, RED], [$2], [NORTH, RED], [$0] (t=7, inv_iters=0)
// ASM-NEXT:     CTRL_MOV, [EAST, RED] -> [WEST, RED] (t=18, inv_iters=1)
// ASM-NEXT:     CTRL_MOV, [NORTH, RED] -> [SOUTH, RED] (t=18, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=7)
// ASM-NEXT:     {
// ASM-NEXT:     ADD, [$0], [#1] -> [NORTH, RED], [$3] (t=8, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=8)
// ASM-NEXT:     {
// ASM-NEXT:     PHI_START, [WEST, RED], [NORTH, RED] -> [$1], [NORTH, RED], [$0] (t=9, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=9)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=10, inv_iters=0)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$2] (t=10, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=10)
// ASM:     PE(2,1):
// ASM-NEXT:     {
// ASM-NEXT:     GEP, [$0] -> [SOUTH, RED], [$4] (t=11, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=11, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     ADD, [WEST, RED], [#1] -> [NORTH, RED], [$3] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [SOUTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [$1] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     LOAD, [WEST, RED] -> [$0] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$2] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$1] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$2], [$1] -> [$2] (t=14, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=14, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$0] (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     FMUL_FADD, [NORTH, RED], [$0], [$1] -> [$1] (t=15, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=15, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=4)
// ASM-NEXT:     {
// ASM-NEXT:     MEMSET, [SOUTH, RED], [$2], [$0] (t=16, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=5)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$3], [$0] -> [WEST, RED] (t=17, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=6)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=7, inv_iters=0)
// ASM-NEXT:     STORE, [$1], [$4] (t=18, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=7)
// ASM-NEXT:     {
...
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [NORTH, RED], [$0] -> [SOUTH, RED] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=6, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=6)
// ASM:     PE(0,2):
// ASM-NEXT:     {
// ASM-NEXT:     GEP, [$0] -> [$0] (t=11, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=11, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [EAST, RED] -> [SOUTH, RED] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     LOAD, [$0] -> [EAST, RED] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [EAST, RED] -> [$1] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     LOAD, [$0] -> [EAST, RED] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [$1] -> [SOUTH, RED] (t=14, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     STORE, [EAST, RED], [$0] (t=15, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=4)
// ASM-NEXT:     {
...
// ASM:     PE(1,2):
// ASM-NEXT:     {
// ASM-NEXT:     NOT, [$0] -> [SOUTH, RED], [$3], [WEST, RED] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [SOUTH, RED], [$1] -> [EAST, RED], [NORTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     LOAD, [SOUTH, RED] -> [$0] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [EAST, RED] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$1] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     FMUL_FADD, [$0], [$1], [WEST, RED] -> [WEST, RED] (t=14, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [EAST, RED] (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$2], [$3] -> [SOUTH, RED] (t=15, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=15, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [EAST, RED] -> [$1] (t=15, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=4)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [$1] -> [SOUTH, RED] (t=16, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=5)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=6, inv_iters=0)
// ASM-NEXT:     CTRL_MOV, [EAST, RED] -> [SOUTH, RED] (t=17, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=6)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=8, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=8)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=9, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=9)
// ASM-NEXT:     {
// ASM-NEXT:     ICMP_EQ, [$0], [EAST, RED] -> [$0], [SOUTH, RED], [$1], [WEST, RED] (t=10, inv_iters=0)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$2] (t=10, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=10)
// ASM:     PE(2,2):
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_ONCE, [#0] -> [SOUTH, RED], [$0] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [SOUTH, RED] -> [SOUTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     ICMP_EQ, [SOUTH, RED], [WEST, RED] -> [$0] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     NOT, [$0] -> [SOUTH, RED], [WEST, RED], [$1] (t=14, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [EAST, RED] -> [$0] (t=14, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [SOUTH, RED] (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     MEMSET, [NORTH, RED], [SOUTH, RED], [$0] (t=15, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [$0] (t=15, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=4)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [$1] -> [WEST, RED] (t=16, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=5)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [EAST, RED], [SOUTH, RED] -> [$0] (t=8, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=8)
// ASM-NEXT:     {
// ASM-NEXT:     ZEXT, [$0] -> [WEST, RED] (t=9, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=9)
// ASM:     PE(3,2):
// ASM-NEXT:     {
// ASM-NEXT:     ZEXT, [$0] -> [$0] (t=12, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [SOUTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     SHL, [$0], [#3] -> [WEST, RED] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [NORTH, RED] -> [$0] (t=6, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=6)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_PREDICATE, [$0], [SOUTH, RED] -> [$0], [WEST, RED] (t=7, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=7)
// ASM:     PE(1,3):
// ASM-NEXT:     {
// ASM-NEXT:     GEP, [$0] -> [$0] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     LOAD, [$0] -> [SOUTH, RED] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$1] (t=2, inv_iters=0)
// ASM-NEXT:     GRANT_PREDICATE, [EAST, RED], [$1] -> [EAST, RED] (t=13, inv_iters=1)
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [SOUTH, RED] (t=13, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=2)
// ASM-NEXT:     {
// ASM-NEXT:     RETURN (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [SOUTH, RED] -> [$0] (t=9, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=9)
// ASM:     PE(2,3):
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_ONCE, [arg3] -> [WEST, RED] (t=12, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=1)
// ASM-NEXT:     {
// ASM-NEXT:     DATA_MOV, [WEST, RED] -> [SOUTH, RED] (t=14, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=3)
// ASM:     PE(3,3):
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_ONCE, [arg4] -> [SOUTH, RED] (t=11, inv_iters=1)
// ASM-NEXT:     } (idx_per_ii=0)
// ASM-NEXT:     {
// ASM-NEXT:     GRANT_ONCE, [arg0] -> [SOUTH, RED] (t=5, inv_iters=0)
// ASM-NEXT:     } (idx_per_ii=5)
