...
// MAPPING-NEXT:     %67 = "neura.data_mov"(%64) {dfg_id = 83 : i32, mapping_locs = [{id = 4009 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 9 : i32, resource = "register", time_step = 17 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %169 = neura.grant_predicate %167, %168 {dfg_id = 210 : i32, mapping_locs = [{id = 14 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 16 : i32, x = 2 : i32, y = 3 : i32}]} : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
...
// MAPPING-NEXT:     %172 = neura.grant_predicate %170, %171 {dfg_id = 209 : i32, mapping_locs = [{id = 11 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 16 : i32, x = 3 : i32, y = 2 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %181 = neura.grant_predicate %179, %180 {dfg_id = 206 : i32, mapping_locs = [{id = 6 : i32, index_per_ii = 5 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 17 : i32, x = 2 : i32, y = 1 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %223 = "neura.data_mov"(%222) {dfg_id = 237 : i32, mapping_locs = [{id = 321 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 1 : i32, resource = "register", time_step = 18 : i32}]} : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
// MAPPING-NEXT:     neura.return_void %223 : !neura.data<i1, i1> {dfg_id = 242 : i32, mapping_locs = [{id = 10 : i32, index_per_ii = 7 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 19 : i32, x = 2 : i32, y = 2 : i32}]}
...
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [EAST, RED] -> [$8], [NORTH, RED] (t=1, inv_iters=0)
...
// ASM-NEXT: {
// ASM-NEXT:   GEP, [arg3], [$1] -> [EAST, RED], [NORTH, RED] (t=6, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$8], [$16] -> [$0], [EAST, RED] (t=7, inv_iters=0)
...
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [$16] (t=9, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [NORTH, RED], [$9] -> [$0] (t=6, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [WEST, RED], [#1] -> [EAST, RED], [$9] (t=6, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$16] -> [WEST, RED] (t=9, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [arg4], [$1] -> [NORTH, RED], [$0] (t=5, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [SOUTH, RED] (t=5, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$8] -> [NORTH, RED], [$8], [EAST, RED] (t=6, inv_iters=0)
...
// ASM: PE(1,2):
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$16], [$9] -> [$0] (t=10, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$24], [$10] -> [$1] (t=11, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [SOUTH, RED], [$1] -> [WEST, RED], [$24] (t=4, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$9] (t=7, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$0] (t=7, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$10] (t=8, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   STORE, [#0], [$0] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM: PE(3,3):
// ASM-NEXT: {
