...
// MAPPING-NEXT:     %115 = "neura.data_mov"(%114) {dfg_id = 144 : i32, mapping_locs = [{id = 24 : i32, index_per_ii = 16 : i32, invalid_iterations = 0 : i32, resource = "link", time_step = 16 : i32}, {id = 28 : i32, index_per_ii = 0 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 17 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %116 = "neura.data_mov"(%109) {dfg_id = 142 : i32, mapping_locs = [{id = 7 : i32, index_per_ii = 16 : i32, invalid_iterations = 0 : i32, resource = "link", time_step = 16 : i32}, {id = 20 : i32, index_per_ii = 0 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 17 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %117 = "neura.mul"(%115, %116) {dfg_id = 152 : i32, mapping_locs = [{id = 10 : i32, index_per_ii = 1 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 18 : i32, x = 2 : i32, y = 2 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     %124 = "neura.data_mov"(%117) {dfg_id = 160 : i32, mapping_locs = [{id = 33 : i32, index_per_ii = 1 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 18 : i32}, {id = 19 : i32, index_per_ii = 2 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 19 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %125 = "neura.add"(%123, %124) {dfg_id = 181 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<i32, i1>) -> !neura.data<i32, i1>
// MAPPING-NEXT:     %126 = "neura.data_mov"(%125) {dfg_id = 191 : i32, mapping_locs = [{id = 2000 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 20 : i32}]} : (!neura.data<i32, i1>) -> !neura.data<i32, i1>
...
// MAPPING-NEXT:     "neura.store"(%126, %127) {dfg_id = 202 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 21 : i32, x = 2 : i32, y = 0 : i32}]} : (!neura.data<i32, i1>, !neura.data<!llvm.ptr, i1>) -> ()
...
// MAPPING-NEXT:     %140 = neura.grant_predicate %138, %139 {dfg_id = 189 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 2 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 19 : i32, x = 2 : i32, y = 0 : i32}]} : !neura.data<!llvm.ptr, i1>, !neura.data<i1, i1> -> !neura.data<!llvm.ptr, i1>
...
// MAPPING-NEXT:     %143 = neura.grant_predicate %141, %142 {dfg_id = 188 : i32, mapping_locs = [{id = 1 : i32, index_per_ii = 2 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 19 : i32, x = 1 : i32, y = 0 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %146 = neura.grant_predicate %144, %145 {dfg_id = 187 : i32, mapping_locs = [{id = 6 : i32, index_per_ii = 6 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 23 : i32, x = 2 : i32, y = 1 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %149 = neura.grant_predicate %147, %148 {dfg_id = 186 : i32, mapping_locs = [{id = 9 : i32, index_per_ii = 13 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 13 : i32, x = 1 : i32, y = 2 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %162 = "neura.data_mov"(%92) {dfg_id = 134 : i32, mapping_locs = [{id = 31 : i32, index_per_ii = 11 : i32, invalid_iterations = 0 : i32, resource = "link", time_step = 11 : i32}]} : (!neura.data<i64, i1>) -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %164 = neura.grant_predicate %162, %163 {dfg_id = 157 : i32, mapping_locs = [{id = 9 : i32, index_per_ii = 12 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 12 : i32, x = 1 : i32, y = 2 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %201 = neura.grant_predicate %199, %200 {dfg_id = 229 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 0 : i32, y = 2 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %212 = "neura.data_mov"(%181) {dfg_id = 205 : i32, mapping_locs = [{id = 28 : i32, index_per_ii = 14 : i32, invalid_iterations = 0 : i32, resource = "link", time_step = 14 : i32}]} : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
// MAPPING-NEXT:     %213 = neura.grant_predicate %211, %212 {dfg_id = 211 : i32, mapping_locs = [{id = 10 : i32, index_per_ii = 15 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 15 : i32, x = 2 : i32, y = 2 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %216 = neura.grant_predicate %214, %215 {dfg_id = 210 : i32, mapping_locs = [{id = 9 : i32, index_per_ii = 16 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 16 : i32, x = 1 : i32, y = 2 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %231 = "neura.data_mov"(%223) {dfg_id = 252 : i32, mapping_locs = [{id = 14 : i32, index_per_ii = 2 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 19 : i32}]} : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
// MAPPING-NEXT:     %232 = neura.grant_predicate %230, %231 {dfg_id = 258 : i32, mapping_locs = [{id = 6 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 20 : i32, x = 2 : i32, y = 1 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// MAPPING-NEXT:     %234 = "neura.data_mov"(%223) {dfg_id = 251 : i32, mapping_locs = [{id = 16 : i32, index_per_ii = 2 : i32, invalid_iterations = 1 : i32, resource = "link", time_step = 19 : i32}, {id = 288 : i32, index_per_ii = 3 : i32, invalid_iterations = 1 : i32, per_tile_register_id = 0 : i32, resource = "register", time_step = 20 : i32}]} : (!neura.data<i1, i1>) -> !neura.data<i1, i1>
// MAPPING-NEXT:     %235 = neura.grant_predicate %233, %234 {dfg_id = 257 : i32, mapping_locs = [{id = 9 : i32, index_per_ii = 4 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 21 : i32, x = 1 : i32, y = 2 : i32}]} : !neura.data<i64, i1>, !neura.data<i1, i1> -> !neura.data<i64, i1>
...
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$1], [$8] -> [WEST, RED] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$1] (t=12, inv_iters=0)
...
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$9] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$1], [$8] -> [NORTH, RED] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$0], [NORTH, RED] -> [$0] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   STORE, [$0], [$9] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$8] (t=14, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=14)
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [NORTH, RED] -> [NORTH, RED] (t=16, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$1] (t=16, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=16)
// ASM: PE(0,1):
// ASM-NEXT: {
// ASM-NEXT:   CONSTANT, [arg1] -> [$0] (t=1, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [$8] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
...
// ASM-NEXT:   CTRL_MOV, [SOUTH, RED] -> [$12] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_ONCE, [$0] -> [SOUTH, RED], [EAST, RED], [$0], [$10] (t=4, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [SOUTH, RED] -> [$16] (t=21, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [NORTH, RED] -> [$24] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [SOUTH, RED], [$0] -> [$0], [EAST, RED] (t=5, inv_iters=0)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [$17] (t=22, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [NORTH, RED] -> [$11] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$17] -> [EAST, RED], [$0] (t=6, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$8] -> [EAST, RED], [$0] (t=9, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$9] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$16] -> [$1], [EAST, RED] (t=10, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [SOUTH, RED], [$11] -> [$0] (t=11, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$8] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$24] -> [$0] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [SOUTH, RED] (t=12, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$12] -> [SOUTH, RED], [$0] (t=13, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [NORTH, RED] (t=14, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=14)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [arg5], [$1], [$9] -> [NORTH, RED] (t=15, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=15)
// ASM-NEXT: {
// ASM-NEXT:   NOT, [$10] -> [SOUTH, RED] (t=16, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=16)
// ASM: PE(1,1):
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$1], [$9] -> [WEST, RED] (t=17, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$9] (t=17, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
// ASM-NEXT:   ICMP_EQ, [$0], [$9] -> [$0] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   NOT, [$0] -> [EAST, RED], [$9], [NORTH, RED] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$0] -> [SOUTH, RED] (t=20, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [EAST, RED] -> [$0] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$9] -> [WEST, RED] (t=21, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [NORTH, RED] -> [$1] (t=21, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [NORTH, RED] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [WEST, RED], [$1] -> [EAST, RED], [$0] (t=7, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$8] -> [WEST, RED], [EAST, RED], [$0] (t=8, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$0], [#1] -> [$0], [$9] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   ICMP_EQ, [$0], [NORTH, RED] -> [$0], [$8], [NORTH, RED], [EAST, RED], [WEST, RED] (t=10, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   NOT, [$0] -> [$16], [NORTH, RED], [WEST, RED] (t=11, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=11, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [SOUTH, RED] (t=11, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$0] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [$0] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$16] -> [EAST, RED] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [$16] -> [SOUTH, RED] (t=12, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$0], [#1] -> [NORTH, RED], [$1] (t=13, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$9], [$16] -> [$8] (t=14, inv_iters=0)
...
// ASM-NEXT: } (idx_per_ii=15)
// ASM-NEXT: {
// ASM-NEXT:   ADD, [$0], [#1] -> [$0], [EAST, RED] (t=16, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$9] (t=16, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=16)
// ASM: PE(2,1):
// ASM-NEXT: {
// ASM-NEXT:   GEP, [arg3], [$17], [$2] -> [SOUTH, RED] (t=17, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [NORTH, RED] (t=17, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$10] (t=17, inv_iters=1)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$1] (t=17, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [NORTH, RED], [$0] (t=18, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=1)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$9] -> [WEST, RED] (t=19, inv_iters=1)
...
// ASM-NEXT:   CTRL_MOV, [SOUTH, RED] -> [$18] (t=20, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [$11] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_ONCE, [arg1] -> [WEST, RED] (t=4, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$10], [$0] -> [$8] (t=22, inv_iters=1)
// ASM-NEXT:   CTRL_MOV, [NORTH, RED] -> [$16] (t=22, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=5)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [NORTH, RED] (t=6, inv_iters=0)
// ASM-NEXT:   GRANT_PREDICATE, [$17], [$3] -> [$9] (t=23, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=6)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$0] (t=7, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=7)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$1] (t=8, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=8)
// ASM-NEXT: {
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$2] (t=9, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=9)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$8] -> [$0] (t=10, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=10)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$16] -> [$16], [$0] (t=11, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$8] (t=11, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=11)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$9] -> [$17], [$0] (t=12, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$9] (t=12, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=12)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [NORTH, RED], [WEST, RED] (t=13, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [SOUTH, RED] (t=13, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [$3] (t=13, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=13, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=13)
// ASM-NEXT: {
// ASM-NEXT:   GEP, [arg4], [$16], [$9] -> [$0] (t=14, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=14)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$0], [$18] -> [SOUTH, RED] (t=15, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=15)
// ASM-NEXT: {
// ASM-NEXT:   PHI_START, [$1], [$11] -> [EAST, RED], [$0] (t=16, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [NORTH, RED] -> [$9] (t=16, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=16)
// ASM: PE(3,1):
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=0)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$0], [$8] -> [WEST, RED] (t=19, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
...
// ASM-NEXT: } (idx_per_ii=2)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [$1], [$8] -> [SOUTH, RED] (t=20, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=3)
// ASM-NEXT: {
// ASM-NEXT:   CTRL_MOV, [EAST, RED] -> [SOUTH, RED] (t=21, inv_iters=1)
// ASM-NEXT: } (idx_per_ii=4)
// ASM-NEXT: {
// ASM-NEXT:   GRANT_PREDICATE, [SOUTH, RED], [EAST, RED] -> [EAST, RED] (t=15, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [SOUTH, RED] -> [$1] (t=15, inv_iters=0)
