...
//         // So the current_step on the target tile is the same as
//         deadlinestep. if (current_step == deadline_step) {
...
//             getAvailableRegister(state, dst_tile, current_step,
//             deadline_step);
//         if (!available_register) {
//           llvm::errs() << "[tryRouteDataMove] No available register found
//           for"
//                        << "dst_tile: " << dst_tile->getId()
//                        << " from time step: " << current_step
//                        << " till deadline step: " << deadline_step << "\n";
//           // None of the register is available, skip this route and try
//           // others.
//           continue;
//         }
...
//         //          << " from time step: " << current_step
//         //          << " till deadline step: " << deadline_step << "\n";
//         // Register is available, so we can occupy the specific register
//         // across remaining time steps.
...
//           // Double-checks if the register is available across the time
//           steps. assert(state.isAvailableAcrossTime(register_loc));
//         }
